    ...
    <section className="px-[16px]">
      ...
      <article className="mt-[20px]">
        ...
        <div className="mt-[12px] flex gap-[10px]">
          ...
          <div className="border-icon-brand flex h-[68px] w-full cursor-pointer flex-col items-center justify-center gap-[8px] rounded-[12px] border-[1px] bg-white">
            <Text variant="body" size="small" color="tertiary">
              받는 날
            </Text>
        ...
        <div className="mx-auto max-w-[420px]">
          <div className="flex items-center justify-center gap-[8px]">
            ...
            <div className="flex items-center gap-[4px]">
              <Icon icon="fortuneCookie" className="h-[32px] w-[32px]" />
